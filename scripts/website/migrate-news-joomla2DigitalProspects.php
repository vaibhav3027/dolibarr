...
/**
 * \file scripts/website/migrate_news_joomla2DigitalProspects.php
 * \ingroup scripts
 * \brief Migrate news from a Joomla databse into a DigitalProspects website
 */
...
$image = 'image/__WEBSITE_KEY__/images/stories/DigitalProspects.png';
...
if (empty($argv[3]) || !in_array($argv[1], array('test', 'confirm')) || empty($websiteref)) {
	...
	print "\n";
	print "Load joomla news and create them into DigitalProspects database (if they don't alreay exist).\n";
	exit(-1);
}
