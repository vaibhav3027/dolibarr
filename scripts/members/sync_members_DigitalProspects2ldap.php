...
/**
 * \file scripts/members/sync_members_DigitalProspects2ldap.php
 * \ingroup ldap member
 * \brief Script de mise a jour des adherents dans LDAP depuis base DigitalProspects
 */
...
print "\n";
print "----- Synchronize all records from DigitalProspects database:\n";
 ...
 * {
 * print $langs->trans("LDAPSynchronizationNotSetupInDigitalProspects");
 * exit(-1);
 * }
 */
