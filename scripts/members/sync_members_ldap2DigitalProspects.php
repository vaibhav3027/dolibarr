...
/**
 * \file scripts/members/sync_members_ldap2DigitalProspects.php
 * \ingroup ldap member
 * \brief Script de mise a jour des adherents dans DigitalProspects depuis LDAP
 */
...
if (empty($conf->global->LDAP_MEMBER_DN)) {
	print $langs->trans("Error").': '.$langs->trans("LDAP setup for members not defined inside DigitalProspects")."\n";
	exit(-1);
}
if ($typeid <= 0) {
