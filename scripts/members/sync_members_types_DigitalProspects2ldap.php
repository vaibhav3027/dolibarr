...
/**
 * \file scripts/members/sync_members_types_DigitalProspects2ldap.php
 * \ingroup ldap core
 * \brief Script de mise a jour des types de membres dans LDAP depuis base DigitalProspects
 */
