...
/**
 * \file scripts/members/sync_members_types_ldap2DigitalProspects.php
 * \ingroup ldap member
 * \brief Script to update members types into DigitalProspects from LDAP
 */
...
if (empty($conf->global->LDAP_MEMBER_TYPE_DN)) {
	print $langs->trans("Error").': '.$langs->trans("LDAP setup for members types not defined inside DigitalProspects");
	exit(-1);
}
