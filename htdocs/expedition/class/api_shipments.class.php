 ...
 */
class Shipments extends DigitalProspectsApi
{
    ...
    public function get($id)
    {
        ...
        if (!DigitalProspectsApi::_checkAccessToResource('expedition', $this->shipment->id)) {
    ...
    {
        if (!DigitalProspectsApiAccess::$user->rights->expedition->creer) {
        ...
        if ($this->shipment->create(DigitalProspectsApiAccess::$user) < 0) {
    ...
    */
    ...
    public function deleteLine($id, $lineid)
    {
        ...
        $request_data = (object) $request_data;
        $updateRes = $this->shipment->deleteline(DigitalProspectsApiAccess::$user, $lineid);
        if ($updateRes > 0) {
            return $this->get($id);
        }
        else
    ...
    public function put($id, $request_data = null)
    {
        ...
        if ($this->shipment->update(DigitalProspectsApiAccess::$user) > 0)
        {
            return $this->get($id);
        }
        else
    ...
    {
    	if (!DigitalProspectsApiAccess::$user->rights->expedition->supprimer) {
            throw new RestException(401);
        }
        $result = $this->shipment->fetch($id);
        if (!$result) {
        ...
        if (!$this->shipment->delete(DigitalProspectsApiAccess::$user)) {
    ...
    public function validate($id, $notrigger = 0)
    {
        ...
        $result = $this->shipment->valid(DigitalProspectsApiAccess::$user, $notrigger);
        if ($result == 0) {
    ...
    public function setinvoiced($id)
    {
        ...
        $result = $this->shipment->classifyBilled(DigitalProspectsApiAccess::$user);
        if( $result < 0) {
    ...
    */
    ...
    public function createShipmentFromOrder($orderid)
    {
        ...
        $result = $this->shipment->createFromOrder($order, DigitalProspectsApiAccess::$user);
        if( $result < 0) {
                throw new RestException(405, $this->shipment->error);
        }
        $this->shipment->fetchObjectLinked();
