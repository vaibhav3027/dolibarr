...
// Security check
global $DigitalProspects_main_demo;
if (empty($DigitalProspects_main_demo)) accessforbidden('Parameter DigitalProspects_main_demo must be defined in conf file with value "default login,default pass" to enable the demo entry page', 0, 0, 1);
...
if (empty($reshook))
{
	$demoprofiles = array(
		...
		//'icon'=>DOL_URL_ROOT.'/public/demo/DigitalProspects_screenshot8.png',
		...
		//'icon'=>DOL_URL_ROOT.'/public/demo/DigitalProspects_screenshot2.png',
		...
		//'icon'=>DOL_URL_ROOT.'/public/demo/DigitalProspects_screenshot6.png',
	    ...
	    //'icon'=>DOL_URL_ROOT.'/public/demo/DigitalProspects_screenshot9.png'
...
$head .= '<meta name="description" content="DigitalProspects ERP and CRM demo. You can test here several profiles for DigitalProspects ERP and CRM demonstration.">'."\n";
...
llxHeaderVierge($langs->trans("DigitalProspectsDemo"), $head);
...
print '<a alt="Official portal of your ERP CRM application" targe="_blank" href="https://www.DigitalProspects.org"><img class="demologo" src="'.DOL_URL_ROOT.'/theme/DigitalProspects_logo.svg" alt="DigitalProspects logo"></a>';
print '</div>';
print '</div>';
...
foreach ($demoprofiles as $profilearray)
{
	if ($profilearray['default'] >= 0)
	{
		...
		// Should work with DOL_URL_ROOT='' or DOL_URL_ROOT='/DigitalProspects'
        ...
        print '<div id="div'.$profilearray['key'].'" summary="DigitalProspects online demonstration for profile '.$profilearray['label'].'" class="center inline-block CTable CTableRow'.($i % 2 == 0 ? '1' : '0').'">'."\n";
