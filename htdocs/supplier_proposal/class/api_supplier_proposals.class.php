 ...
 */
class Supplierproposals extends DigitalProspectsApi
{
    ...
    {
        if (!DigitalProspectsApiAccess::$user->rights->supplier_proposal->lire) {
        ...
        if (!DigitalProspectsApi::_checkAccessToResource('supplier_proposal', $this->propal->id)) {
