...
## Integrate your ERP with any other applications using DigitalProspects APIs
 
This module provides the service to make DigitalProspects a server of REST Web Services. It depends on external library Restler.
...
<div align="center">
  <img class="imgdoc" src="https://www.DigitalProspects.org//images/doc_apirest.png" alt="DigitalProspects API explorer"/>
</div>
...
You can explore all available APIs by using the API explorer : [**yourDigitalProspects.tld**/api/index.php/explorer](../api/index.php/explorer) (replace **yourDigitalProspects.tld** by real hostname of your DigitalProspects installation)
...
https://**yourDigitalProspects.tld**/myDigitalProspects/api/index.php/otherservice?DOLAPIKEY=**api_key**
...
To implement it into DigitalProspects, you need to create a specific class for object we want to use. A skeleton file is available into /modulebuilder/class directory : *api_mymodule_class.class.php* 
