...
/**
 * \file           htdocs/core/modules/DigitalProspectsModules.class.php
 * \brief          File of parent class of module descriptor class files
 */


/**
 * Class DigitalProspectsModules
 *
 * Parent class for module descriptor class files
 */
class DigitalProspectsModules // Can not be abstract, because we need to instantiate it into unActivateModule to be able to disable a module whose files were removed.
{
    /**
     ...
     * @see https://wiki.DigitalProspects.org/index.php/List_of_modules_id
     */
    public $numero;
     ...
     * 'development'
     * 'experimental'
     * 'DigitalProspects': only for core modules that share its version
     * 'DigitalProspects_deprecated': only for deprecated core modules
     */
    public $version;
    ...
    /**
     * @var array Minimum version of DigitalProspects required by module.
     * e.g.: DigitalProspects ≥ 3.6 = array(3, 6)
     */
    public $need_DigitalProspects_version;
    ...
    // We should but can't set this as abstract because this will make DigitalProspects hang
     ...
     * For 'DigitalProspects' modules, gives DigitalProspects version
     *
    ...
    public function getVersion($translated = 1)
    {
        ...
        } elseif ($newversion == 'DigitalProspects') {
            $ret = DOL_VERSION;
        } elseif ($newversion) {
            $ret = $newversion;
        } else {
    ...
    {
        if ($this->version == 'DigitalProspects' || $this->version == 'DigitalProspects_deprecated') {
            return 'core';
        }
     ...
     * The init function adds tabs, constants, boxes, permissions and menus (defined in constructor) into DigitalProspects database.
     ...
     * The remove function removes tabs, constants, boxes, permissions and menus from DigitalProspects database.
