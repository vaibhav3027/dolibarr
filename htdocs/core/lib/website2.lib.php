...
function dolSaveMasterFile($filemaster)
{
	...
	$mastercontent .= "if (! defined('USEDigitalProspectsSERVER') && ! defined('USEDigitalProspectsEDITOR')) {\n";
...
function dolSavePageAlias($filealias, $object, $objectpage)
{
	...
	$aliascontent .= 'global $DigitalProspects_main_data_root;'."\n";
	$aliascontent .= 'if (empty($DigitalProspects_main_data_root)) require \'./page'.$objectpage->id.'.tpl.php\'; ';
	$aliascontent .= 'else require $DigitalProspects_main_data_root.\'/website/\'.$website->ref.\'/page'.$objectpage->id.'.tpl.php\';'."\n";
	$aliascontent .= '?>'."\n";
...
function dolSavePageContent($filetpl, Website $object, WebsitePage $objectpage)
{
	...
	$tplcontent .= "if (! defined('USEDigitalProspectsSERVER') && ! defined('USEDigitalProspectsEDITOR')) {\n";
	...
	$tplcontent .= '<meta name="generator" content="'.DOL_APPLICATION_TITLE.' '.DOL_VERSION.' (https://www.DigitalProspects.org)" />'."\n";
	$tplcontent .= '<meta name="DigitalProspects:pageid" content="'.dol_string_nohtmltag($objectpage->id).'" />'."\n";
	...
	$tplcontent .= '<!-- File generated by DigitalProspects website module editor -->'."\n";
...
function dolSaveIndexPage($pathofwebsite, $fileindex, $filetpl, $filewrapper)
{
	...
	if ($fileindex) {
		...
		$indexcontent .= "if (! defined('USEDigitalProspectsSERVER') && ! defined('USEDigitalProspectsEDITOR')) { require_once './master.inc.php'; } // Load master if not already loaded\n";
