...
class DolEditor
{
     ...
     *  @param 	string	$toolbarname	       		 	Name of bar set to use ('Full', 'DigitalProspects_notes[_encoded]', 'DigitalProspects_details[_encoded]'=the less featured, 'DigitalProspects_mailings[_encoded]', 'DigitalProspects_readonly').
