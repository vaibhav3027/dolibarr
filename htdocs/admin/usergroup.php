...
elseif ($action == 'del_default')
{
	...
	if ($ret > 0)
	{
        if ($conf->global->USERGROUP_ADDON_PDF_ODT == "$value") DigitalProspects_del_const($db, 'USERGROUP_ADDON_PDF_ODT', $conf->entity);
	}
	$res = true;
}
...
{
	if (DigitalProspects_set_const($db, "USERGROUP_ADDON_PDF_ODT", $value, 'chaine', 0, '', $conf->entity))
	{
