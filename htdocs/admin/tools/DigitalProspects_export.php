...
/**
 *		\file 		htdocs/admin/tools/DigitalProspects_export.php
 *		\ingroup	core
...
print $langs->trans("BackupDesc3", $DigitalProspects_main_db_name).'<br>';
...
print $langs->trans("DatabaseName").' : <b>'.$DigitalProspects_main_db_name.'</b><br>';
print '</td>';
print '</tr>';
...
{
	print '<br><font class="warning">'.$langs->trans("YouMustRunCommandFromCommandLineAfterLoginToUser", $DigitalProspects_main_db_user, $DigitalProspects_main_db_user).':</font><br>'."\n";
...
$prefix = 'documents';
$ext = 'zip';
$file = $prefix.'_'.$DigitalProspects_main_db_name.'_'.dol_sanitizeFileName(DOL_VERSION).'_'.strftime("%Y%m%d%H%M");
