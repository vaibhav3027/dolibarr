...
/**
 *  \file       htdocs/admin/system/DigitalProspects.php
...
{
    $result = getURLContent('https://sourceforge.net/projects/DigitalProspects/rss');
...
$title = $langs->trans("InfoDigitalProspects");
...
print '<a href="https://raw.githubusercontent.com/DigitalProspects/DigitalProspects/'.$version.'/ChangeLog" target="_blank">'.$langs->trans("SeeChangeLog").'</a>';
print '</td></tr>'."\n";
...
print '<div class="div-table-responsive-no-min">';
print '<table class="noborder centpercent">';
print '<tr class="liste_titre"><td class="titlefield">'.$langs->trans("LocalisationDigitalProspectsParameters").'</td><td>'.$langs->trans("Value").'</td></tr>'."\n";
...
$txt .= $langs->trans("DigitalProspects constant MAIN_SERVER_TZ").': '.(empty($conf->global->MAIN_SERVER_TZ) ? $langs->trans("NotDefined") : $conf->global->MAIN_SERVER_TZ);
...
$configfileparameters = array(
		'DigitalProspects_main_url_root' => $langs->trans("URLRoot"),
		'?DigitalProspects_main_url_root_alt' => $langs->trans("URLRoot").' (alt)',
		'DigitalProspects_main_document_root'=> $langs->trans("DocumentRootServer"),
		'?DigitalProspects_main_document_root_alt' => $langs->trans("DocumentRootServer").' (alt)',
		'DigitalProspects_main_data_root' => $langs->trans("DataRootServer"),
        'DigitalProspects_main_instance_unique_id' => $langs->trans("InstanceUniqueID"),
        'separator1' => '',
		'DigitalProspects_main_db_host' => $langs->trans("DatabaseServer"),
		'DigitalProspects_main_db_port' => $langs->trans("DatabasePort"),
		'DigitalProspects_main_db_name' => $langs->trans("DatabaseName"),
		'DigitalProspects_main_db_type' => $langs->trans("DriverType"),
		'DigitalProspects_main_db_user' => $langs->trans("DatabaseUser"),
		'DigitalProspects_main_db_pass' => $langs->trans("DatabasePassword"),
		'DigitalProspects_main_db_character_set' => $langs->trans("DBStoringCharset"),
		'DigitalProspects_main_db_collation' => $langs->trans("DBSortingCollation"),
		'?DigitalProspects_main_db_prefix' => $langs->trans("Prefix"),
		'separator2' => '',
		'DigitalProspects_main_authentication' => $langs->trans("AuthenticationMode"),
        '?multicompany_transverse_mode'=>  $langs->trans("MultiCompanyMode"),
		'separator'=> '',
		'?DigitalProspects_main_auth_ldap_login_attribute' => 'DigitalProspects_main_auth_ldap_login_attribute',
		'?DigitalProspects_main_auth_ldap_host' => 'DigitalProspects_main_auth_ldap_host',
		'?DigitalProspects_main_auth_ldap_port' => 'DigitalProspects_main_auth_ldap_port',
		'?DigitalProspects_main_auth_ldap_version' => 'DigitalProspects_main_auth_ldap_version',
		'?DigitalProspects_main_auth_ldap_dn' => 'DigitalProspects_main_auth_ldap_dn',
		'?DigitalProspects_main_auth_ldap_admin_login' => 'DigitalProspects_main_auth_ldap_admin_login',
		'?DigitalProspects_main_auth_ldap_admin_pass' => 'DigitalProspects_main_auth_ldap_admin_pass',
		'?DigitalProspects_main_auth_ldap_debug' => 'DigitalProspects_main_auth_ldap_debug',
		'separator3' => '',
		'?DigitalProspects_lib_ADODB_PATH' => 'DigitalProspects_lib_ADODB_PATH',
		'?DigitalProspects_lib_FPDF_PATH' => 'DigitalProspects_lib_FPDF_PATH',
		'?DigitalProspects_lib_TCPDF_PATH' => 'DigitalProspects_lib_TCPDF_PATH',
		'?DigitalProspects_lib_FPDI_PATH' => 'DigitalProspects_lib_FPDI_PATH',
		'?DigitalProspects_lib_TCPDI_PATH' => 'DigitalProspects_lib_TCPDI_PATH',
		'?DigitalProspects_lib_NUSOAP_PATH' => 'DigitalProspects_lib_NUSOAP_PATH',
		'?DigitalProspects_lib_PHPEXCEL_PATH' => 'DigitalProspects_lib_PHPEXCEL_PATH',
		'?DigitalProspects_lib_GEOIP_PATH' => 'DigitalProspects_lib_GEOIP_PATH',
		'?DigitalProspects_lib_ODTPHP_PATH' => 'DigitalProspects_lib_ODTPHP_PATH',
		'?DigitalProspects_lib_ODTPHP_PATHTOPCLZIP' => 'DigitalProspects_lib_ODTPHP_PATHTOPCLZIP',
		'?DigitalProspects_js_CKEDITOR' => 'DigitalProspects_js_CKEDITOR',
		'?DigitalProspects_js_JQUERY' => 'DigitalProspects_js_JQUERY',
		'?DigitalProspects_js_JQUERY_UI' => 'DigitalProspects_js_JQUERY_UI',
		'?DigitalProspects_js_JQUERY_FLOT' => 'DigitalProspects_js_JQUERY_FLOT',
		'?DigitalProspects_font_DOL_DEFAULT_TTF' => 'DigitalProspects_font_DOL_DEFAULT_TTF',
		'?DigitalProspects_font_DOL_DEFAULT_TTF_BOLD' => 'DigitalProspects_font_DOL_DEFAULT_TTF_BOLD',
		'separator4' => '',
		'DigitalProspects_main_prod' => 'Production mode (Hide all error messages)',
		'DigitalProspects_main_restrict_os_commands' => 'Restrict CLI commands for backups',
		'DigitalProspects_main_restrict_ip' => 'Restrict access to some IPs only',
		'?DigitalProspects_mailing_limit_sendbyweb' => 'Limit nb of email sent by page',
		'?DigitalProspects_mailing_limit_sendbycli' => 'Limit nb of email sent by cli',
		'?DigitalProspects_strict_mode' => 'Strict mode is on/off',
		'?DigitalProspects_nocsrfcheck' => 'Disable CSRF security checks'
);
...
foreach ($configfileparameters as $key => $value)
{
	...
	if (empty($ignore))
	{
		...
		else
		{
			...
			elseif ($newkey == 'DigitalProspects_main_document_root_alt') {
			...
			} elseif ($newkey == 'DigitalProspects_main_instance_unique_id') {
			    //print $conf->file->instance_unique_id;
			    global $DigitalProspects_main_cookie_cryptkey;
			    $valuetoshow = ${$newkey} ? ${$newkey} : $DigitalProspects_main_cookie_cryptkey; // Use $DigitalProspects_main_instance_unique_id first then $DigitalProspects_main_cookie_cryptkey
			    print $valuetoshow;
			    if (empty($valuetoshow)) {
			        print img_warning("EditConfigFileToAddEntry", 'DigitalProspects_main_instance_unique_id');
			    }
			    print ' &nbsp; <span class="opacitymedium">('.$langs->trans("HashForPing").'='.md5('DigitalProspects'.$valuetoshow).')</span>';
			} elseif ($newkey == 'DigitalProspects_main_prod') {
				print ${$newkey};
