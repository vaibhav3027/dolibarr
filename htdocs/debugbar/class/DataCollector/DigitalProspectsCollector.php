...
/**
 * DigitalProspectsCollector class
 */

class DigitalProspectsCollector extends DataCollector implements Renderable, AssetProvider
{
	/**
	...
	/**
	 *	Return DigitalProspects info as an HTML string
	 *
	 * @return string      HTML string
	 */
	protected function getDigitalProspectsInfo()
	{
		global $conf, $langs;
	...
	public function getWidgets()
	{
		return array(
			...
			"DigitalProspects_info" => array(
				"icon" => "desktop",
				"indicator" => "PhpDebugBar.DebugBar.TooltipIndicator",
				"tooltip" => array(
					"html" => $this->getDigitalProspectsInfo(),
					"class" => "tooltip-wide"
				),
				"map" => "",
				"default" => ""
