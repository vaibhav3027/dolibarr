 ...
 *
 *              exten => s,1,Set(CALLERID(name)=${CURL(http://IP-DigitalProspects:80/asterisk/cidlookup.php?phone=${CALLERID(num)})})
 *
 *			    Change IP-DigitalProspects to the IP address of your DigitalProspects server
 */
