...
(
  ...
  ref_ext               varchar(30),					-- reference into an external system (not used by DigitalProspects)
  ref_int				varchar(30),					-- reference into an internal system (used by DigitalProspects to store extern id like paypal info)
