...
// Use its own include to not share the include of DigitalProspects
// This is a standalone feature with no information from DigitalProspects to show
// and no database access to do.
include_once 'inc.php';
$uri = preg_replace('/^http(s?):\/\//i', '', $DigitalProspects_main_url_root);
...
pHeader($langs->trans("DigitalProspectsHelpCenter"), $_SERVER["PHP_SELF"]);
...
print $langs->trans("ToGoBackToDigitalProspects", $homeurl);
...
$urlwiki = 'https://wiki.DigitalProspects.org';
if (preg_match('/fr/i', $langs->defaultlang)) $urlwiki = 'https://wiki.DigitalProspects.org/index.php/Accueil';
if (preg_match('/es/i', $langs->defaultlang)) $urlwiki = 'https://wiki.DigitalProspects.org/index.php/Portada';
print '<br>'.$langs->trans("ForDocumentationSeeWiki", $urlwiki, $urlwiki);
print '<br>';
$urlforum = 'https://www.DigitalProspects.org/forum/';
$urlforumlocal = 'https://www.DigitalProspects.org/forum/';
if (preg_match('/fr/i', $langs->defaultlang)) $urlforumlocal = 'https://www.DigitalProspects.fr/forum/';
if (preg_match('/es/i', $langs->defaultlang)) $urlforumlocal = 'https://www.DigitalProspects.es/foro/';
if (preg_match('/it/i', $langs->defaultlang)) $urlforumlocal = 'http://www.DigitalProspects.it/forum/';
if (preg_match('/gr/i', $langs->defaultlang)) $urlforumlocal = 'https://www.DigitalProspects.gr/forum/';
...
print '</td>';
print '</tr><tr>';
$urlwiki = 'https://partners.DigitalProspects.org';
