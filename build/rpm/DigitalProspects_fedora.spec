...
echo Run post script of packager DigitalProspects_fedora.spec
...
semanage fcontext -a -t httpd_sys_script_rw_t "/etc/DigitalProspects(/.*?)"
semanage fcontext -a -t httpd_sys_script_rw_t "/var/lib/DigitalProspects(/.*?)"
