...
# Usage: DigitalProspects-doxygen-filter.pl pathtofilefromDigitalProspectsroot

$file=$ARGV[0];
if (! $file)
{
	print "Usage: DigitalProspects-doxygen-filter.pl pathtofilefromDigitalProspectsroot\n";
	exit;
}
