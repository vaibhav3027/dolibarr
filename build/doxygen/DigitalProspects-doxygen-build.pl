...
$CONFFILE="DigitalProspects-doxygen.doxyfile";
...
if (! -s $CONFFILE)
{
    print "Error: current directory for building DigitalProspects doxygen documentation is not correct.\n";
    print "\n";
	print "Change your current directory then, to launch the script, run:\n";
	print '> perl .\DigitalProspects-doxygen-build.pl  (on Windows)'."\n";
	print '> perl ../DigitalProspects-doxygen-build.pl  (on Linux or BSD)'."\n";
    sleep 4;
    exit 1;   
}
