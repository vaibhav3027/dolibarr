...
# changes on files in its DigitalProspects tree.
# The output patch file can then be submited on DigitalProspects dev mailing-list,
...
then 
    ...
    echo Example: buildpatch.sh  /mydirA/DigitalProspectsold  /mydirB/DigitalProspectsnew
else
