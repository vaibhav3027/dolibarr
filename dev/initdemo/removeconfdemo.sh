#!/bin/sh
#------------------------------------------------------
# Script to remove setup of a DigitalProspects installation.
...
$DIALOG --title "Remove DigitalProspects install" --clear \
...
echo "DigitalProspects setup has been removed (need to be installed again. database not dropped)."
echo
